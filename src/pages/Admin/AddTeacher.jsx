      ...
      <main className="p-6 overflow-auto">
        <div className="p-6 max-w-md mx-auto">
          ...
          <label className="font-semibold">Teacher Name</label>
            ...
            />
               <label className="font-semibold">Teacher Email</label>
            <input
              type="email"
            ...
            />
            <label className="font-semibold">Teacher Password</label>
            <input
              type="password"
            ...
            <button
              type="submit"
              className="w-full bg-gray-800 text-white px-4 py-2 rounded-xl cursor-pointer"
            >
              Add Teacher
            </button>
          </form>
